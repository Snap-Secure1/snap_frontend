...
export default function CommercialPage() {
  return (
    <div className="min-h-screen bg-background">
      <Navigation currentPath="/industries/commercial" />
          ...
          <div className="lg:col-span-2">
            ...
            <div className="bg-gradient-to-r from-blue-50 to-emerald-50 rounded-lg p-6">
              ...
              <p className="text-muted-foreground">
                With years of experience serving the commercial sector, our team understands the specific challenges and
          ...
          <aside className="lg:col-span-1">
            <Card className="p-6 mb-6">
              ...
              <p className="text-muted-foreground mb-6">
                Contact us for a customized security assessment and quote tailored to your commercial needs.
              </p>
              <Link href="/#contact">
