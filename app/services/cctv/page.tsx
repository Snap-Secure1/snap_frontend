...
export const metadata: Metadata = {
  ...
  description:"Get professional CCTV Installation Services in Miyapur, Hyderabad. Ensure safety with reliable, high-quality surveillance solutions for home & business.",
