...
export const metadata: Metadata = {
  title: "Biometric Access Control - SnapSecure Technologies",
  description: "Fingerprint, facial recognition, RFID access, MFA, attendance, and integration with existing systems.",
}
